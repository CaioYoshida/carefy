...
var PatientAppointmentsController = /** @class */ (function () {
    function PatientAppointmentsController() {
    }
    PatientAppointmentsController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var appointmentRepository, patient_id, patientAppointments;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        patientAppointments = _a.sent();
                        if (!patientAppointments) {
                            return [2 /*return*/, response.status(404).json({ message: 'not found' })];
                        }
                        return [2 /*return*/, response.status(200).json(patientAppointments)];
                }
            });
        });
    };
...
exports.default = new PatientAppointmentsController();
